...
if file is not None:
    ...
    people = st.selectbox(
        '인구 데이터 분석',
        ('우리 동네 인구 구조', '남성, 여성 인구 비교',  '성별 비율 파이 차트','인구 구조가 가장 비슷한 지역 찾기'), 
        index=2
    )

    if people == '우리 동네 인구 구조':
    ...
    elif people == '인구 구조가 가장 비슷한 지역 찾기':
